...
import com.uah.es.views.matrículas.MatrículasView;
...
public class MainLayout extends AppLayout {
    ...
    private List<Tab> createMenuItems() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("Matrículas", "la la-archive", MatrículasView.class), //

                new MenuItemInfo("Usuarios", "la la-user-friends", UsuariosView.class), //
